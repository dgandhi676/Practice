...
if (isset($_POST['update'])) {
    ...
    $stmt = $conn->prepare("UPDATE product_master SET pro_name = ?, pro_image = ?, pro_category = ?, pro_des = ?, pro_inactive = ?, pro_sellprice = ?, pro_discprice = ?, pro_disco = ? WHERE pro_id = ?");
    $stmt->bind_param("ssssssssi", $proname, $profolder1, $prooption, $prodes, $activein, $prosell, $prodis, $dicena1, $id);


    if ($stmt->execute()) {
        echo "Product Updated";
        header('Location: http://localhost/Dev/target/admin/products.php');
    } else {
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h2 class="text-center">Update Products
                    ...
                    <form action="" method="post" id="productform" enctype="multipart/form-data" onsubmit="return validateform()" class="needs-validation" novalidate>
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="proname" name="proname" aria-describedby="pronameHelp" placeholder="Enter your Product Name" value="<?php echo $fet['pro_name']; ?>">
                            </div>
                            <br>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <img src="<?php echo $fet['pro_image']; ?>" class="img-thumbnail" alt="Image Preview" style="max-height: 125px; max-width: 125px;">
                            </div>
                            <input type="hidden" name="hiddenproimg" id="hiddenproimg" value="<?php echo $fet['pro_image']; ?>">
                            <br>
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="prooption" name="prooption">
                                    ...
                                    <?php foreach ($activeCategories as $category) {
                                        $selected = ($fet['pro_category'] == $category['cat_name']) ? 'selected' : '';
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control form-control-md" name="prodes" id="prodes" placeholder="Enter Product Description"><?php echo $fet['pro_des']; ?></textarea>
                            </div>
                            <br>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="prosell" id="prosell" class="form-control" placeholder="Enter your Product Sell Price" value="<?php echo $fet['pro_sellprice']; ?>">
                            </div>
                            <br>
                            <div class="col-md-6">
                                <label for="prodis" class="form-label">Discount Price: </label>
                                <input type="number" name="prodis" id="prodis" class="form-control" placeholder="Enter your Product Discount Price" value="<?php echo $fet['pro_discprice']; ?>">
                            </div>
                            <br>
                            <div class="col-mb-3">
