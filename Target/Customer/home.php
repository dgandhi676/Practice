...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary">
        <div class="container-fluid">
            ...
            <button type="button" class="btn btn-outline-danger mx-2 my-2 my-lg-0 d-flex align-items-center" onclick="window.location.href='loginsignup.php'">
                <i class="bi bi-box-arrow-in-right" style="font-size: 25px; margin-right: 5px;"></i> Login/Signup
            </button>
        </div>
    </nav>
    <div class="container-fluid">
