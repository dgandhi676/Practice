...
<body>
    ...
    <h1 class="bg-primary-subtle text-bg-info text-center py-3 px-5">
        Category List
        <a href="categoryadd.php" class="btn btn-outline-primary float-end mt-2">Add Category</a>
    </h1>
        ...
        <div class="row my-3">
            <div class="col-12">
                <form method="GET" action="">
                    ...
                    <button type="button" class="btn btn-outline-danger mt-2 mx-3 col-1" onclick="window.location.href='category.php'">Reset</button>
                </form>
            </div>
        </div>
            ...
            <table class="table table-bordered table-hover table-secondary rounded-4">
                ...
                <tr colspan="5">
                    ...
                    if ($num1 = mysqli_num_rows($run1) > 0){
                        ...
                        echo "<td colspan='6'><No class='text-center text-danger'>No Categories Found!</p></td>";
                    }
                    ?>
                </tr>
                <?php
