                    ...
                    <form action="" method="post" id="teamform" enctype="multipart/form-data" onsubmit="return validateform()" class="needs-validation" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select country" id="country" name="country" onload="loadStates()"></select>
                            </div>
                            <br>
                            <input type="hidden" name="hiddenstate" id="hiddenstate" value="<?php echo $fet['ot_state']; ?>">
                            <div class="col-md-4">
                                <label for="state" class="form-label">Select State:</label>
                                <select class="form-select state" id="state" name="state" onload="loadCities()"></select>
                            </div>
                            <br>
